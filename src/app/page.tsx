  ...
  const [isNormal, setIsNormal] = useState(true);
      ...
      <div className="relative w-2/5 h-3/5 rounded-2xl  flex flex-col items-center bg-transparent">
        <div className="w-full h-1/5 bg-transparent ">
          <div><Link className="absolute top-0 left-0 mt-4 mr-4 h-12 w-32 bg-blue-500 text-white font-bold py-2 px-4 rounded" href="/Pro">Pro</Link></div>
